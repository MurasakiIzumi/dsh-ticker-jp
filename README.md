...
- **多语言界面**：内置 16 种界面语言——简体中文 / 繁體中文 / English / 日本語 / Français / Deutsch / Español / Italiano / Português / Русский / 한국어 / ไทย / Tiếng Việt / Bahasa Indonesia / Türkçe / العربية，首次运行按浏览器语言自动匹配（zh-Hant/zh-TW/zh-HK/zh-MO → 繁中，其余 zh → 简中，ja/en 及各语种前缀直接对应，其它回退英文），可在 ⚙ 面板下拉切换并保存；内建短名随语言本地化（如 Nikkei 225 / 日经225 / 日經225 / 닛케이 225 / 日経225）
...
6. 「语言」下拉在配色按钮上方：简体中文 / 繁體中文 / English / 日本語 / Français / Deutsch / Español / Italiano / Português / Русский / 한국어 / ไทย / Tiếng Việt / Bahasa Indonesia / Türkçe / العربية（共 16 种），切换即时生效并保存
